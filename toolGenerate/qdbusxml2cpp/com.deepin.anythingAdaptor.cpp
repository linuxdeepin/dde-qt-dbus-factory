...
#include "./dde-qt-dbus-factory/toolGenerate/qdbusxml2cpp/com.deepin.anythingAdaptor.h"
...
QStringList AnythingAdaptor::search(int maxCount, qlonglong maxTime, uint startOffset, uint endOffset, const QString &path, const QString &keyword, bool useRegExp, uint &startOffset_, uint &endOffset_)
{
    // handle method call com.deepin.anything.search
    //return static_cast<YourObjectType *>(parent())->search(maxCount, maxTime, startOffset, endOffset, path, keyword, useRegExp, startOffset_, endOffset_);
}
