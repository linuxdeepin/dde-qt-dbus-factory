 ...
 * Command line was: qdbusxml2cpp -c Notifications -p org_freedesktop_notifications xml/org.freedesktop.Notifications.xml
 *
...
public:
    Notifications(const QString &service, const QString &path, const QDBusConnection &connection, QObject *parent = 0);
...
namespace org {
  namespace freedesktop {
    typedef ::Notifications Notifications;
  }
}
#endif
